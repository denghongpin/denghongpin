define(["jquery", "text!tlps/riskmain.html", "echarts"], function($, riskmain, echarts) {
    return function() {
        $(".risk_content").html(riskmain);
        //饼图
        var leftPic = document.getElementById("topPie");
        ...
        //折线图
        var footerpic = document.getElementById("mianFooter");
